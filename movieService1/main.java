...
public class main {
	...
	static ReviewService reviewService = new 
	ReviewService(userService, movieService, userLevelService);
	...
	public static void main(String[] args) throws Exception {
        ...
        // reviewService.add_review(user1.getName(), movie1.getName(), 10);  // gives expected exception
